...
//    open lateinit var dataBinding: // Later Will Be Updated
    ...
    companion object {
         fun instanceWithLayout(): ComponentCardItems {
            val fragment = ComponentCardItems()
    ...
    private fun loadAllComponentsOutlet(context: Context?) {
        var adapterData: Array<ComponentCardModel> = arrayOf(ComponentCardModel(), ComponentCardModel())
        this.adapter = ComponentCardItemsAdapter(adapterData)
